...
function connectWebSocket() {
    ...
    socket.onmessage = (event) => {
        ...
        console.log('recip id = ', incomingMessage.recipient_id, ' selected user id = ', selectedUserId)
...
function startMessagePolling(userId) {
    ...
    messagePollingInterval = setInterval(() => loadMessages(userId), 10000);
}
...
setInterval(fetchUsers, 40000); // Обновление каждые 10 секунд
